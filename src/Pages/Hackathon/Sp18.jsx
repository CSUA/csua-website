      ...
      <div className={'wrapper'}>
        ...
        <div className={'info-area'}>
          ...
          <div id="rules1">
              ...
              <div className="headers">
                  Prize Pool:
                  <div className="prize-item">Four Large HD Monitors</div>
                  <div className="prize-item">Two Headphones</div>
                  <div className="prize-item">Two Jamboxes</div>
                  <div className="prize-item">Four Raspberry Pis</div>
              </div>
          </div>
          <div id="rules2">
              <div className="headers">
